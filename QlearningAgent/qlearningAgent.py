...
class QLearningAgent:
    ...
    def __init__(self,plane,Map = None,actionFn = None, alpha=0.5, gamma=1,state = [0,0,0]):
        ...
        # self.stateReward = 0
        # self.values = {}
        # self.values[(str([0,0,0]),str([1,0,0]))] = 0
        # self.values[(str([0,0,0]),str([0,1,0]))] = 0
        # self.values[(str([0,0,0]),str([0,0,1]))] = 0
        # self.values[(str([1,0,0]),str([-1,0,0]))] = 0
        # self.values[(str([1,0,0]),str([0,1,0]))] = 0
        # self.values[(str([1,0,0]),str([0,0,1]))] = 0
        # self.values[(str([0,1,0]),str([1,0,0]))] = 0
        # self.values[(str([0,1,0]),str([0,-1,0]))] = 0
        # self.values[(str([0,1,0]),str([0,0,1]))] = 0
        # self.values[(str([0,0,1]),str([1,0,0]))] = 0
        # self.values[(str([0,0,1]),str([0,1,0]))] = 0
        # self.values[(str([0,0,1]),str([0,0,-1]))] = 0

        # self.values[(str([1,1,0]),str([-1,0,0]))] = 0
        # self.values[(str([1,1,0]),str([0,1,0]))] = 0
        # self.values[(str([1,1,0]),str([0,0,1]))] = 100
        # self.values[(str([0,1,1]),str([1,0,0]))] = 100
        # self.values[(str([0,1,1]),str([0,-1,0]))] = 0
        # self.values[(str([0,1,1]),str([0,0,1]))] = 0
        # self.values[(str([1,0,1]),str([1,0,0]))] = 0
        # self.values[(str([1,0,1]),str([0,1,0]))] = 100
        # self.values[(str([1,0,1]),str([0,0,-1]))] = 0
        self.state = state
